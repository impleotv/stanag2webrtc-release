...
```bash
docker run --network host impleo/stanag2webrtc:1.0.10 -url udp://227.1.1.1:30120
```
...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **Stanag2WebRTC** |  v1.0.10 | [SetupStanag2WebRtc.zip](https://github.com/impleotv/stanag2webrtc-release/releases/latest/download/SetupStanag2WebRtc.zip) | 

> Note. Windows version requires **GStreamer** demux patch. Without the patch, streams with SYNC KLV will not work.


*Released on Tue, 7 Feb, 18:47 GMT+2*
